...
public class FormOmodalidad {
    ...
    public FormOmodalidad() {
        titulo = new Label("OBTENER MODALIDAD");
        ...
        observacion = new Label("Descripcion: ");
        ...
        bingresar.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                try {
                    ...
                    alerta.setTitle("INFORMACION DEL SISTEMA");
                    alerta.setHeaderText(null);
                    alerta.setContentText("Error al buscar Modalidad: " + e.getMessage());
                    alerta.showAndWait();
                }
            }
        });
